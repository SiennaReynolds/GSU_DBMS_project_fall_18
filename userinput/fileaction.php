...
.score_box{
	...
	<?php
		$userinput = $_POST["files"];
		$file = fopen($userinput, "r") or die("Unable to open file!");
		$j = file_get_contents($userinput,FALSE,null);
		
		echo'<script type="text/javascript">
		var FleschKincaid = exports;
		document.getElementById("original").innerHTML = "Original text:<br><br><p>\"',$j,'\"</p>";
